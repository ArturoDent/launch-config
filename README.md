...
[ &#10004; ] - Explore running multiple debug sessions from one keybinding.  
[ &#10004; ] - Provide intellisense for settings.json, with all `"names"` fron launch.json.  
[ &#10004; ] - Provide intellisense for `launches.` commands in keybindings.json from settings.json keys.  
